...
public class TerMerchant extends DataEntity<TerMerchant> {
    ...
    @Override
    public int hashCode() {
        return this.merchantNum.hashCode();
    }

    @Override
    public boolean equals(Object obj) {
        if (obj instanceof TerMerchant) {
            TerMerchant terMerchant = (TerMerchant) obj;
            return this.merchantNum.equals(terMerchant.getMerchantNum());
        }
        return false;
    }
}