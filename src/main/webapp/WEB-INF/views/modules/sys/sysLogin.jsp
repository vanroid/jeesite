...
<head>
    ...
    <style type="text/css">
        html, body, table {
            background: url(${pageContext.request.contextPath}/static/images/login_bgx.gif);
            width: 100%;
            text-align: center;
        }
        ...
        .form-div {
            ...
            width: 70%;
            height: auto;
            background-image: url(${pageContext.request.contextPath}/static/images/kj_login_bg.jpg);
...
<div class="form-div">
    <form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
        <img src="${pageContext.request.contextPath}/static/images/logo.png" width="100%">
