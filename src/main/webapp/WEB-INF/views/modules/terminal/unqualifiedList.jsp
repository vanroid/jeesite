...
<head>
    ...
    <script type="text/javascript">
        ...
        function page(n, s) {
            $("#pageNo").val(n);
            $("#pageSize").val(s);
            $("#searchForm").attr("action","${ctx}/terminal/terBillMonth/unqualified");
            $("#searchForm").submit();
            return false;
        }
    </script>
    ...
    <tr>
        <td colspan="30">
            <ul class="nav nav-tabs">
                <li class="active"><a href="${ctx}/terminal/terBillMonth/unqualified">不达标记录</a></li>
            </ul>
            <form:form id="searchForm" modelAttribute="terBillMonth" action="${ctx}/terminal/terBillMonth/unqualified"
                ...
                <ul class="ul-form">
                    <li><label>清算日期：</label>
                        <input name="clearDate" type="text" readonly="readonly" maxlength="20"
                               ...
                               value="<fmt:formatDate value="${terBillMonth.clearDate}" pattern="yyyy-MM-dd"/>"
